...
<section id="category" class="category">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4">
				<div class="category-item">
					<a href="${contextPath}/restaurant/restaurantList.do?item=all" class="thumbnail">
			...
			<div class="col-md-4">
				<div class="category-item">
					<a href="${contextPath}/restaurant/restaurantList.do?item=한식" class="thumbnail">
			...
			<div class="col-md-4">
				<div class="category-item">
					<a href="${contextPath}/restaurant/restaurantList.do?item=치킨" class="thumbnail">
			...
			<div class="col-md-4">
				<div class="category-item">
					<a href="${contextPath}/restaurant/restaurantList.do?item=양식" class="thumbnail">
			...
			<div class="col-md-4">
				<div class="category-item">
					<a href="${contextPath}/restaurant/restaurantList.do?item=일식" class="thumbnail">
			...
			<div class="col-md-4">
				<div class="category-item">
					<a href="${contextPath}/restaurant/restaurantList.do?item=중식" class="thumbnail">
			...
			<div class="col-md-4">
				<div class="category-item">
					<a href="${contextPath}/restaurant/restaurantList.do?item=고기" class="thumbnail">
			...
			<div class="col-md-4">
				<div class="category-item">
					<a href="${contextPath}/restaurant/restaurantList.do?item=분식" class="thumbnail">
			...
			<div class="col-md-4">
				<div class="category-item">
					<a href="${contextPath}/restaurant/restaurantList.do?item=주류" class="thumbnail">
			...
			<div class="col-md-4">
				<div class="category-item">
					<a href="${contextPath}/restaurant/restaurantList.do?item=카페" class="thumbnail">
			...
			<div class="col-md-4">
				<div class="category-item">
					<a href="${contextPath}/restaurant/restaurantList.do?item=기타" class="thumbnail">
